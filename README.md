...
[![npm](https://img.shields.io/npm/v/@odczynflnpm/ipsa-ut-eligendi.svg)](https://www.npmjs.com/package/@odczynflnpm/ipsa-ut-eligendi)
[![downloads](https://img.shields.io/npm/dt/@odczynflnpm/ipsa-ut-eligendi.svg)](https://www.npmjs.com/package/@odczynflnpm/ipsa-ut-eligendi)
[![types](https://img.shields.io/npm/types/@odczynflnpm/ipsa-ut-eligendi.svg)](https://www.npmjs.com/package/@odczynflnpm/ipsa-ut-eligendi)
[![licence](https://img.shields.io/github/license/mnasyrov/@odczynflnpm/ipsa-ut-eligendi.svg)](https://github.com/odczynflnpm/ipsa-ut-eligendi/blob/master/LICENSE)
[![Coverage Status](https://coveralls.io/repos/github/mnasyrov/@odczynflnpm/ipsa-ut-eligendi/badge.svg?branch=main)](https://coveralls.io/github/mnasyrov/@odczynflnpm/ipsa-ut-eligendi?branch=main)
...
| --------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------- |
| [**@odczynflnpm/ipsa-ut-eligendi**][@odczynflnpm/ipsa-ut-eligendi/docs]             | Core elements, state and effect management | [Docs][@odczynflnpm/ipsa-ut-eligendi/docs], [API][@odczynflnpm/ipsa-ut-eligendi/api]             |
| [**@odczynflnpm/ipsa-ut-eligendi-react**][@odczynflnpm/ipsa-ut-eligendi-react/docs] | Tooling for React.js                       | [Docs][@odczynflnpm/ipsa-ut-eligendi-react/docs], [API][@odczynflnpm/ipsa-ut-eligendi-react/api] |
...
```
npm install @odczynflnpm/ipsa-ut-eligendi @odczynflnpm/ipsa-ut-eligendi-react --save
```
...
import {
  ...
  Query,
  withStoreUpdates,
} from '@odczynflnpm/ipsa-ut-eligendi';
...
import { useConst, useObservable, useQuery } from '@odczynflnpm/ipsa-ut-eligendi-react';
...
[@odczynflnpm/ipsa-ut-eligendi/docs]: packages/@odczynflnpm/ipsa-ut-eligendi/README.md
[@odczynflnpm/ipsa-ut-eligendi/api]: packages/@odczynflnpm/ipsa-ut-eligendi/docs/README.md
[@odczynflnpm/ipsa-ut-eligendi-react/docs]: packages/@odczynflnpm/ipsa-ut-eligendi-react/README.md
[@odczynflnpm/ipsa-ut-eligendi-react/api]: packages/@odczynflnpm/ipsa-ut-eligendi-react/docs/README.md
